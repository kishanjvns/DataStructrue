...
public class TrainMapProblem {
    ...
    private static class TrainMap {
            ...
            while (!queue.isEmpty()) {
                ...
                for (Station neighbor : currentStation.getNeighbours()) {
                    if (!visited.contains(neighbor)) {
                        ...
                        if (neighbor.equals(toStation)) {
                            // Reconstruct the path
                            return reconstructPath(parentMap, fromStation, toStation);
                        }
                    }
                }
            }
        ...
        private List<Station> reconstructPath(Map<Station, Station> parentMap, Station from, Station to) {
